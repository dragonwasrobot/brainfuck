        ...
        , Html.div
            ...
            , Html.table [ Attr.id "ascii-table", Attr.class "w-full table-auto" ]
                [ Html.thead [ Attr.class "font-semibold text-center" ]
                    [ Html.tr []
                        [ Html.th [ Attr.class "py-2 border-t-0 border-l-0 border-l-0 border-b" ] [ Html.text "DEC" ]
                        , Html.th [ Attr.class "py-2 border-t-0 border-l-0 border-l-0 border-b" ] [ Html.text "HEX" ]
                        , Html.th [ Attr.class "py-2 border-t-0 border-l-0 border-l-0 border-b" ] [ Html.text "CHAR" ]
                        , Html.th [ Attr.class "py-2 border-t-0 border-l-0 border-l-0 border-b text-left" ] [ Html.text "NAME" ]
                        ]
                    ]
                , Html.tbody [ Attr.class "text-center" ] (List.map viewRow ASCII.table)
                ]
            ]
